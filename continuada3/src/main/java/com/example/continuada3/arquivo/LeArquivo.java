...
//                    dataDeNascimento = Integer.parseInt(registro.substring(14,21));
//                    nome = registro.substring(22,51);
//                    cidade = registro.substring(52,66);
//                    mae = registro.substring(67,96);
//                    pai = registro.substring(97,126);
//
//
//                    System.out.printf("%11s %8d %-30s %-15s %-30s %-30s\n",
//                            cpf,dataDeNascimento,nome,cidade,mae,pai);
